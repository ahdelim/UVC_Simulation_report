subroutine discharge_valve_parameters_1_ver2(no_data, A_cross_dv_1, I_dv_1, beta_r_1, omega_natural_dv_1, omega_response_dv_1)
    ...
    do 370 i = 1,7
        ...
        f_y_down_x3 = rho_dv*2.*(t_dv_1*1.e-3)*(2.*(r_dv1_x3*1.e-3)*(x3 - x_hole_start_1*1.e-3) - (x3 - x_hole_start_1*1.e-3)**2)**(0.5) * ((x3/(l_dv1ef*1.e-3))**4 - (1.5)*(x3/(l_dv1ef*1.e-3))**3 + (0.5)*(x3/(l_dv1ef*1.e-3)))**2
...
370 continue    
    F_down_dv1 = y_down_x1 + y_down_x2 + y_down_x3
    do 275 i=1,no_data+1
        ...
        write(100,*) omega_response_dv_1(i)
275 continue        
    
endsubroutine discharge_valve_parameters_1_ver2