subroutine next_prop_cv_d1(dqdtheta1, dmdtheta1, dedtheta1, p_cv, dvdtheta1, m_cv, u_cv, v_cvn, un, mn, rhon, pn, tn, hn, sn, miun, cvn, cpn, kn, v_cv)
...
end subroutine next_prop_cv_d1