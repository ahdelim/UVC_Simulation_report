        ...
        MODULE OPTIMIZATION_IMPROV_MOVE__genmod
          INTERFACE 
            SUBROUTINE OPTIMIZATION_IMPROV_MOVE(ORI_EXP1,ORI_EXP2,      &
     &ORI_EXP3,ORI_EXP4,ORI_EXP5,ORI_EXP6,ORI_EXP7,ORI_EXP8,ORI_EXP1_2, &
     &ORI_EXP2_2,ORI_EXP3_2,ORI_EXP4_2,ORI_EXP5_2,ORI_EXP6_2,BEST_INDEX,&
     &WORST_INDEX,BEST,WORST,ARRAY_OBJ_FUNC)
              ...
              REAL(KIND=8) :: BEST
              REAL(KIND=8) :: WORST
              REAL(KIND=8) :: ARRAY_OBJ_FUNC(1:OPT_ORI_COMPLEX)
            END SUBROUTINE OPTIMIZATION_IMPROV_MOVE
          END INTERFACE 
        END MODULE OPTIMIZATION_IMPROV_MOVE__genmod
