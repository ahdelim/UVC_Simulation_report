        ...
        MODULE DYNAMIC_M__genmod
          INTERFACE 
            SUBROUTINE DYNAMIC_M(THETA_1,THETA_2,GAMMA_1,L_V,P_SCV,P_DCV&
     &,DGAMMADTT_1,F_VHOC_N,F_VHOC_T,F_1_N,F_2_N,F_CX,F_CY,F_RESULTANT, &
     &T_INERTIA_RO,T_INERTIA_VH,T_COM_C)
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE DYNAMIC_M
          END INTERFACE 
        END MODULE DYNAMIC_M__genmod
