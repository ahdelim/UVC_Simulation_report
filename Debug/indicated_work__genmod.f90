        ...
        MODULE INDICATED_WORK__genmod
          INTERFACE 
            SUBROUTINE INDICATED_WORK(V_SUC,V_COM,P_CSCV_ID,P_CDCV_ID,  &
     &P_SCV,P_DCV,DVDTHETA1_S,DVDTHETA1_D,POWER_IND,POWER_IND_IDEAL,    &
     &POWER_LOSS_SUC,POWER_LOSS_DISC,POWER_COMP_ONLY)
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE INDICATED_WORK
          END INTERFACE 
        END MODULE INDICATED_WORK__genmod
