        !COMPILER-GENERATED INTERFACE MODULE: Thu Jun 20 21:46:02 2019
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE OIL_LUB_NETWORK_VER4__genmod
          INTERFACE 
            SUBROUTINE OIL_LUB_NETWORK_VER4(THETA_1,THETA_2,P_DCV,P_SCV,&
     &ECCR)
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE OIL_LUB_NETWORK_VER4
          END INTERFACE 
        END MODULE OIL_LUB_NETWORK_VER4__genmod
