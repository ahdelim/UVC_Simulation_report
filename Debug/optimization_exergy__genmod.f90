        ...
        MODULE OPTIMIZATION_EXERGY__genmod
          INTERFACE 
            SUBROUTINE OPTIMIZATION_EXERGY(THETA_1,V_COM,V_SUC,P_SCV,   &
     &P_DCV,T_SCV,T_DCV,S_SCV,S_DCV,H_SCV,H_DCV,U_SCV,U_DCV,M_SCV,M_DCV,&
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE OPTIMIZATION_EXERGY
          END INTERFACE 
        END MODULE OPTIMIZATION_EXERGY__genmod
