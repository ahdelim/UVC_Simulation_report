        ...
        MODULE OPTIMIZATION_THERMO_M__genmod
          INTERFACE 
            SUBROUTINE OPTIMIZATION_THERMO_M(THETA_1,THETA_2,DLVDT,     &
     &DGAMMADT_1,V_COM,V_SUC,L_V,P_CSCV_ID,P_CDCV_ID,DVDTHETA1_S,       &
     &DVDTHETA1_D,DQDTHETA_SC,DQDTHETA_DC,DMDTHETA1_SI,DMDTHETA1_SO,    &
     &DMDTHETA1_LEAK_S,DMDTHETA1_DI,DMDTHETA1_DO,P_SCV,M_SCV,T_SCV,U_SCV&
     &,RHO_SCV,H_SCV,S_SCV,MIU_SCV,CV_SCV,CP_SCV,K_SCV,P_DCV,M_DCV,T_DCV&
     &,U_DCV,RHO_DCV,H_DCV,S_DCV,MIU_DCV,CV_DCV,CP_DCV,K_DCV,Q_DCSC_EX, &
     &Q_SCHC_EX,Q_SCRO_EX,Q_SCHC_VD_EX,Q_SCOIL_VD_EX,Q_DCHC_EX,Q_DCRO_EX&
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE OPTIMIZATION_THERMO_M
          END INTERFACE 
        END MODULE OPTIMIZATION_THERMO_M__genmod
