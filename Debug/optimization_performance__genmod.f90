        !COMPILER-GENERATED INTERFACE MODULE: Thu Jun 20 21:45:59 2019
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE OPTIMIZATION_PERFORMANCE__genmod
          INTERFACE 
            SUBROUTINE OPTIMIZATION_PERFORMANCE
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE OPTIMIZATION_PERFORMANCE
          END INTERFACE 
        END MODULE OPTIMIZATION_PERFORMANCE__genmod
