        !COMPILER-GENERATED INTERFACE MODULE: Mon Feb 03 20:07:45 2020
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE POWER_M__genmod
          INTERFACE 
            SUBROUTINE POWER_M(THETA_1,V_SUC,V_COM,P_CSCV_ID,P_CDCV_ID, &
     &P_SCV,P_DCV,H_SCV,H_DCV,DMDTHETA1_SI,DMDTHETA1_SO,DMDTHETA1_LEAK_S&
     &,DMDTHETA1_DI,DMDTHETA1_DO,DVDTHETA1_S,DVDTHETA1_D,DLVDT,         &
     &DGAMMADT_1,F_VHOC_N,F_VHOC_T,F_1_N,F_2_N,F_CX,F_CY,F_RESULTANT,   &
     &ECCR,ATT,T_INERTIA_RO,T_INERTIA_VH,T_COM_C,L_F_VS,L_EF_VH,L_S_VH, &
     &L_EF_RO,L_LUB,P_BEAR_S,L_LIP_SEAL)
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE POWER_M
          END INTERFACE 
        END MODULE POWER_M__genmod
