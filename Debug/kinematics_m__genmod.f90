        !COMPILER-GENERATED INTERFACE MODULE: Thu Jun 20 21:46:07 2019
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE KINEMATICS_M__genmod
          INTERFACE 
            SUBROUTINE KINEMATICS_M(THETA_1,GAMMA_1,L_V,DLVDT,DLVDTT,   &
     &DGAMMADT_1,DGAMMADTT_1,DVDTHETA1_SUC,DVDTHETA1_COM)
     ...
     &,DATA_STEP,DATA_STEP_SUCT,DATA_STEP_HIGH,MAX_WRITE_DATA
            ...
            END SUBROUTINE KINEMATICS_M
          END INTERFACE 
        END MODULE KINEMATICS_M__genmod
