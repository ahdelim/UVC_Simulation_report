        ...
        MODULE OPTIMIZATION_FORCE_MOVE__genmod
          INTERFACE 
            SUBROUTINE OPTIMIZATION_FORCE_MOVE(ORI_EXP1,ORI_EXP2,       &
     ...
     &WORST_INDEX,BEST,WORST,ARRAY_OBJ_FUNC)
            ...
            END SUBROUTINE OPTIMIZATION_FORCE_MOVE
          END INTERFACE 
        END MODULE OPTIMIZATION_FORCE_MOVE__genmod
