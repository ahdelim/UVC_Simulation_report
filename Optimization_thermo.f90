...
subroutine optimization_thermo_main()
    ...
    ! --- Frictional loss
    double precision, dimension (1:no_data+1) :: L_f_vs, L_ef_vh, L_s_vh, L_ef_ro, L_lub, L_lip_seal       ! Losses definition
...
endsubroutine optimization_thermo_main
...
subroutine optimization_power_m(theta_1, v_suc, v_com, p_cscv_id, p_cdcv_id, p_scv, p_dcv, h_scv, h_dcv, dmdtheta1_si, dmdtheta1_so, dmdtheta1_leak_s, dmdtheta1_di, dmdtheta1_do, dvdtheta1_s, dvdtheta1_d, dlvdt, dgammadt_1, F_vhoc_n, F_vhoc_t, F_1_n, F_2_n, F_cx, F_cy, F_resultant, eccr, att, T_inertia_ro, T_inertia_vh, T_com_C, L_f_vs, L_ef_vh, L_s_vh, L_ef_ro, L_lub, P_bear_s, L_lip_seal)
    ...
    do 198 i = 1, no_data+1
        ...
        P_f_loss(i) = L_ef_vh(i) + L_s_vh(i) + L_f_vs(i) + L_ef_ro(i) + L_lub(i) + P_bear_s(i) + L_lip_seal(i)     ! [W]    Instantaneous total frictional power loss
...
198 continue        
        ...
        L_avrg_lip_seal_opt = sum(L_lip_seal)/(no_data+1)
