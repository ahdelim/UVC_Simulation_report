subroutine dynamic_m(theta_1, theta_2, gamma_1, l_v, p_scv, p_dcv, dgammadtt_1, F_vhoc_n, F_vhoc_t, F_1_n, F_2_n, F_cx, F_cy, F_resultant, T_inertia_ro, T_inertia_vh, T_com_C)
    implicit none
...
!167         continue            
            ...
            mat_force_element(6,2) = (r_vh + l_v(i) - l_v_ro - 0.5*coef_vs*w_v_ro)*1.e-3    ! F1n
